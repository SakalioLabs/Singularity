...
AUTHORIZATION_COMMIT = "4aaf0011071c0dc7ca73ee10b9a7e96b337669cb"
...
def test_probe54_authorization_was_issued_unconsumed_then_consumed_at_line_2():
    authorization = _json(AUTHORIZATION_PATH)
    issued = _git_json(
    ...
    assert "probe_54_authorized" not in authorization
    ...
    assert authorization["consumed_report_path"] == (
        "workspace/evals/m4_probe54_report.json"
    )
