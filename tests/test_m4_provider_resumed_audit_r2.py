...
AUDIT_PATH = (
    ROOT / "workspace" / "evals" / "m4_provider_resumed_audit_r2_20260726.json"
)
SCHEMA_PATH = (
    ROOT
    / "workspace"
...
def test_m4_provider_resumed_audit_r2_extends_the_fresh_fail_closed_count():
    ...
    assert prior["resumed_consecutive_count"] == 1
    ...
    assert audit["decision"]["resumed_consecutive_count"] == 2
