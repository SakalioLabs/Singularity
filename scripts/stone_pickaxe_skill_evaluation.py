#!/usr/bin/env python3
"""Authorize, run, and summarize one SP-001 learned-skill evaluation arm."""
...
def parse_args() -> argparse.Namespace:
    ...
    authorize.add_argument("--arm", required=True, choices=("shadow", "advisory", "fallback", "candidate"))
    ...
    run.add_argument("--arm", required=True, choices=("shadow", "advisory", "fallback", "candidate"))
    ...
    report.add_argument(
        "--baseline-output",
        default="workspace/evals/acquire_cobblestone_baseline_index.json",
    )
    report.add_argument(
        "--report-output",
        default="workspace/evals/acquire_cobblestone_paired_evaluation.json",
    )
