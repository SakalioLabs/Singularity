...
- Runtime boundary: candidate `r1` is consumed and cannot be retried. Its first skill dig was verifier-blocked before a world command, ordinary planning recovered the root goal, and all eleven artifacts are retained. No live arm is currently authorized; the nearest-observed fix, regressions, and a new non-overlapping evaluation window must be committed and pushed first. SP-002/SP-003, Probe 24, full BM-012, and iron mining remain unauthorized.
