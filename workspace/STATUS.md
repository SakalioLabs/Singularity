...
- Candidate lifecycle: the acquire 1.1.0 executable transition is complete and rollback-safe. Craft candidate extraction is unlocked only after the third-success evidence commit is pushed and synchronized; candidate and advisory stages remain nonexecutable, and no current skill record may be rewritten in place.
