...
- Current gate: SP-001 3/3 executable; SP-002 3/3 with advisory `1.0.0` awaiting paired evaluation; SP-003 locked.
...
- Candidate lifecycle: the acquire 1.1.0 executable transition is complete and rollback-safe. Phase 59 candidate extraction is pushed at `eba9c82f`; Phase 60 adds only the reviewed SP-002 advisory record and related ledgers. The next gate is a fixed three-pair baseline/candidate evaluation; executable review and SP-003 remain disabled until that evidence exists.
