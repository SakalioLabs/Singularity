...
- M4 is `partial` and still incomplete; BM-011 remains repeat-verified, but BM-012 is only 1/3 after forty retained failed live attempts and one eligible Probe 38 success. The phase is not complete until BM-011 through BM-014 each reach 3/3.
...
- BM-012 is 1/3 after Probe 41. Probe 38 episode `m4_episode_20260726_202651_d80a4946` completed the full empty-hand-to-stone-pickaxe loop, mined eight machine-proven iron-ore sources into `raw_iron:8`, preserved health/hunger at 20, and passed the deadline gate with 172.469 seconds remaining. Probe 39 remained ineligible on occupied-target station placement and is repaired offline. Probe 40 episode `m4_episode_20260726_212750_8fd2d156` again completed the empty-hand-to-stone-pickaxe loop, but remained ineligible after `stone_pickaxe:1`: the old 8-block observation window did not expose the fixed-seed iron cluster, and stone-search digs repeatedly downgraded to `wooden_pickaxe`. Probe 41 episode `m4_episode_20260726_221222_50eaaed0` did not reach cobblestone: after schema-noise recovery, Curriculum selected the coal/torch detour before wooden-pickaxe progression, and the run reached `wooden_pickaxe:1` only near the deadline. The new offline repair locks exact BM-012 toolchain fallback goals before ready-task and Curriculum overrides while preserving urgent survival goals; Probe 42 remains unauthorized until this evidence and repair are committed and pushed, and BM-013/BM-014 remain locked.
...
| M4 | Autonomous Survival | **Partial (`partial`)** | BM-011 repeat_verified 3/3; BM-012 Probe 38 success 1/3 plus Probe 41 retained failure and repair pending push; BM-013..014 not_run |
