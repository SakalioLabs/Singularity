...
- M4 is `partial` and still incomplete; BM-011 remains repeat-verified, but BM-012 is only 2/3 after forty-three retained failed live attempts and two eligible successes. The phase is not complete until BM-011 through BM-014 each reach 3/3.
...
| M4 | Autonomous Survival | **Partial (`partial`)** | BM-011 repeat_verified 3/3; BM-012 Probe 38 and Probe 45 successes 2/3 plus retained failures; BM-013..014 not_run |
