...
- Current gate: SP-001 3/3 executable; SP-002 3/3 with advisory `1.0.0`, fixed paired baselines 3/3, and candidate pairs 0/3; SP-003 locked.
...
- Runtime boundary: SP-002 fixture preparation, source evidence, and paired-evaluation arms use separate parent-bound one-time authorization scopes; output reuse and automatic retry are forbidden. All nine source-phase SP-002 authorizations are consumed. No paired arm is authorized until the Phase 61 definition commit is pushed; SP-003, Probe 24, full BM-012, and iron mining remain unauthorized.
- Candidate lifecycle: the acquire 1.1.0 executable transition is complete and rollback-safe. Phase 59 candidate extraction is pushed at `eba9c82f`; Phase 60 adds only the reviewed SP-002 advisory record and related ledgers. Phase 61 binds three immutable skill-off baselines and starts at 0/3 candidate pairs with no normal-runtime permission. The next gate is a separate `shadow/shadow-1` authorization; executable review and SP-003 remain disabled until all support and candidate evidence exists.
