...
- Phases 0-99 retain the verified SP-001/SP-002 history, SP-003 definition, consumed authorizations, offline repairs, and immutable failures. Phase 98 passes retained replays for the Phase 97 table-reference, movement-metric, and pickup-goal mismatches. Phase 99 retains a zero-action external Planner HTTP 500. Earlier skill records and Probe 21/22/23 hashes remain protected.
