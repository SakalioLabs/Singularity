# STATUS.md | Last updated: 2026-07-26
...
- M4 is `partial` and still incomplete; BM-011 remains repeat-verified, but BM-012 is only 1/3 after forty-three retained failed live attempts and one eligible Probe 38 success. The phase is not complete until BM-011 through BM-014 each reach 3/3.
...
- BM-012 is 1/3 after Probe 44. Probe 38 episode `m4_episode_20260726_202651_d80a4946` completed the full empty-hand-to-stone-pickaxe loop, mined eight machine-proven iron-ore sources into `raw_iron:8`, preserved health/hunger at 20, and passed the deadline gate with 172.469 seconds remaining. Probe 39 remained ineligible on occupied-target station placement and is repaired offline. Probe 40 episode `m4_episode_20260726_212750_8fd2d156` again completed the empty-hand-to-stone-pickaxe loop, but remained ineligible after `stone_pickaxe:1`: the old 8-block observation window did not expose the fixed-seed iron cluster, and stone-search digs repeatedly downgraded to `wooden_pickaxe`. Probe 41 episode `m4_episode_20260726_221222_50eaaed0` did not reach cobblestone because a coal/torch detour preempted wooden-pickaxe progression. Probe 42 episode `m4_episode_20260726_224415_434033de` proved that detour did not recur and reached `wooden_pickaxe:1` plus `cobblestone:1`, but two APITimeout planner calls and 21 slow Grok calls exhausted the 600-second budget before three cobblestone or `stone_pickaxe:1`. Probe 43 episode `m4_episode_20260726_234401_47c150da` reduced Planner pressure with machine-step actions, but repeated a failed `place crafting_table` reference 207 times, never placed the table, and hit the deadline. Probe 44 episode `m4_episode_20260727_001750_6df281a2` exercised the place-feedback repair and avoided the same-reference loop, but 237 failed table-place attempts drifted across 167 references into occupied stone/coal/dirt targets; the table remained in inventory and no wooden-pickaxe or stone loop occurred. The new offline repair bounds table-place candidates to near current observations, excludes failed target cells, and records `m4-bm012-machine-step-place-candidate-bound-v1` on future machine-step place evidence; Probe 45 has one-use zero-retry authorization pending run, and BM-013/BM-014 remain locked.
...
| M4 | Autonomous Survival | **Partial (`partial`)** | BM-011 repeat_verified 3/3; BM-012 Probe 38 success 1/3 plus Probe 44 retained failure and Probe 45 authorization pending run; BM-013..014 not_run |
