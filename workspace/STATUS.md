...
- Runtime boundary: r11 machine-verified in 15.750 seconds with one Planner call, four successful actions, three completed attributed skill digs, zero failures/rejects/fallbacks, and confidence 1.0. Its eleven artifacts and report hash are retained; Paper/Bridge are stopped and ports are clear. `r12`, superseded IDs, support reruns, retries, SP-002/SP-003, Probe 24, full BM-012, and iron mining remain unauthorized pending pushed r11 evidence and a separate next-arm decision.
