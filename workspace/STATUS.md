...
- Phases 0-72 retain the verified SP-001/SP-002 history and the SP-003 offline definition. Phase 73 retains the first SP-003 baseline failure; Phase 74 repairs only the reset-audit contract. The repository, earlier skill records, consumed authorizations, and Probe 21/22/23 hashes remain protected.
- SP-001 Acquire Cobblestone is 3/3 and SP-002 Craft Stone Pickaxe is 3/3. SP-003 is not live-verified: one baseline authorization failed before any LLM call or Agent action, baseline remains 0/1, and candidates remain 0/3.
...
- SP-003 starts in a fresh seed-12345 survival world with exact empty inventory and requires the full `logs -> table -> wooden pickaxe -> three stone -> stone pickaxe` machine-verified chain. The retained baseline reset was clean but exposed an audit mismatch for absent fixture metadata and natural 67-tick daylight drift; the corrected replay and tamper controls pass 20/20 dedicated cases. No SP-003 live authorization is currently present.
