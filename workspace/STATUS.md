...
- M4 is `failing` and still incomplete. BM-011, BM-012, and BM-013 are each repeat-verified at 3/3 after eligible Probe 50 closed BM-013. BM-014 is failing at 0/3 after one authorized attempt: Probe 51 reached furnace crafting but exhausted the 300-second episode while trying to place that furnace in unobserved occupied cave cells.
...
| M4 | Autonomous Survival | **Failing (`failing`)** | BM-011, BM-012, and BM-013 repeat_verified 3/3; BM-014 failing 0/3 after Probe 51, bounded placement repair pushed/read back, Probe 52 authorization pending its own push/readback |
