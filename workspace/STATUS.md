...
- SP-001 Acquire Cobblestone is 1/3, SP-002 Craft Stone Pickaxe is 0/3, and SP-003 Composite Stone Pickaxe Chain is 0/3 and locked.
- `learned:acquire_cobblestone` and `learned:craft_stone_pickaxe` do not exist. No candidate, advisory, paired evaluation, or executable promotion has been created. Two failed SP-001 episodes remain retained, and the first independent eligible success is hash-bound without granting capability or M4 credit.
...
- Current gate: SP-001 1/3; SP-002 0/3; SP-003 locked.
- Runtime state: the controlled fixture/snapshot/SP-001 harness passes 30/30 protocol and 27/27 runtime cases. Four failed preparations, one successful preparation, two failed SP-001 episodes, and one eligible SP-001 success each ran once and stopped. Thirty SP-001 artifacts are retained and hash-bound.
...
- Current authorization: one conditional SP-001 episode after the first successful evidence set and its full audit are committed and pushed. No automatic retry, concurrent or batch SP-001, SP-002/SP-003, Probe 24, full BM-012, or iron mining is authorized.
