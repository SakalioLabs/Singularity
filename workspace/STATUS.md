...
- Phases 0-91 retain the verified SP-001/SP-002 history, SP-003 definition, consumed authorizations, and immutable failures. Phase 92 offline-verifies the SP-003-only craft-settlement and bounded buried-stone surface-clearance repair. Earlier skill records and Probe 21/22/23 hashes remain protected.
- SP-001 Acquire Cobblestone is 3/3 and SP-002 Craft Stone Pickaxe is 3/3. SP-003 is not live-verified: eight baseline authorizations are consumed, baseline remains 0/1, and candidates remain 0/3. Seven produced gameplay failures; one created no episode because Node rejected the bare preload module specifier before Bridge readiness.
