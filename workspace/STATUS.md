...
- BM-012 is the next target at 0/3 after twenty-one failed live attempts. Probe 21 ran once from pushed commit `84ca601` and live-activated `m4-ready-task-goal-verifier-success-criteria-v1`: all 61 binding reports retained or suppressed unverified completion, with zero allow decisions. Exact bound task `7790c984` failed before event 970 placed the table, so event 974 correctly suppressed the generic event-973 achievement. Runner event 318 recovered through that table and the event-1491 wooden pickaxe. The new earliest layer is `m4_readiness_recovery_inventory_family_root_completion_disconnect`: event 1504 selected an exact-`oak_log` recovery for stale task `d37f41ea`; events 1512/1513 machine-completed the recovery from `dark_oak_log:4`, but event 1519 still planned from exact `oak_log:0` and event 1532 moved unnecessarily. The root consumed nine cycles and was suspended at dusk with six stale crafting tasks accepted. The episode ended at the deadline with no iron and 64/74 checks passing. Probe 21's authorization is consumed; Probe 22 is locked until a bounded offline root-completion gate is implemented, validated, committed, and pushed. BM-013/BM-014 remain locked.
