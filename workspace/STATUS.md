...
- Phases 0-114 retain the verified SP-001/SP-002 history, SP-003 definition, consumed authorizations, offline repairs, and immutable failures. Phase 113 live-confirms the stop-drain repair and exposes omitted down-step transition headroom; Phase 114 repairs that boundary offline without changing the shared Bridge, vendored Pathfinder, or base protocol. Earlier skill records and Probe 21/22/23 hashes remain protected.
...
- SP-003 starts in a fresh seed-12345 survival world with exact empty inventory and requires the full `logs -> table -> wooden pickaxe -> three stone -> stone pickaxe` machine-verified chain. Phase 113 evidence is pushed at `b5f9ceb2`. Phase 114 requires transition upper-head air, clears the retained `(124,141,-38)` dirt before the lower stone, and prevents exact movement failure from becoming a tolerance warning-success. Audit `2cd04b4a...`, SP-003 86/86, stone-pickaxe 267/267, full Python 1022/1022, and Node 80/80 pass. The fix still awaits this commit/push and the full chain is still not live-proven.
...
- Phase 113's exact 13-file failed bundle is pushed and immutable. Phase 114's bounded transition-clearance repair is offline-verified at SP-003 86/86, stone-pickaxe 267/267, repository Python 1022/1022, and Node 80/80.
- The next transaction is this Phase 114 fix commit and push. Only afterward may a separate parent-bound one-use baseline authorization be committed and pushed; candidate execution remains locked until a baseline completes the full empty-hand-to-stone-pickaxe chain.
