...
- Runtime state: the controlled fixture/snapshot/SP-001 harness passes 30/30 protocol and 30/30 runtime cases. Four failed preparations, one successful preparation, five failed SP-001 episodes, and three eligible SP-001 successes each ran once and stopped. Eighty SP-001 artifacts are retained and hash-bound.
...
- Current authorization: no further SP-001 live episode. Candidate extraction becomes available only after the third success evidence is committed and pushed. SP-002/SP-003, Probe 24, full BM-012, and iron mining remain unauthorized.
