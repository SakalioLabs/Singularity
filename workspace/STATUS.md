...
- M4 is `live_observed` but still incomplete. BM-011, BM-012, and BM-013 are each repeat-verified at 3/3 after eligible Probe 50 closed BM-013. BM-014 is live-observed at 1/3 after three authorized attempts: Probes 51 and 53 are retained as two failures, while Probe 52 independently completed the full empty-inventory iron-pickaxe chain. Two independently eligible successes remain required.
...
| M4 | Autonomous Survival | **Live observed (`live_observed`)** | BM-011, BM-012, and BM-013 repeat_verified 3/3; BM-014 live_observed 1/3 after 3 attempts / 2 failures, Probe 53 evidence and owned-table repair pushed/read back, clean portability gate passed, Probe 54 authorization staged pending its own push/readback, Probe 55 unauthorized |
