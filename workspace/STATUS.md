...
- M4 is `partial` and still incomplete. BM-011, BM-012, and BM-013 are each repeat-verified at 3/3 after eligible Probe 50 closed BM-013; BM-014 has not run and remains locked until the Probe 50 evidence is committed and pushed and its exact stick-goal verifier blocker is repaired.
...
- BM-013 is `repeat_verified` after eligible Probes 48, 49, and 50. Probe 50 episode `m4_episode_20260727_111149_e1794e58` consumed its one-use authorization at `autonomous_start` line 2, completed all nine goals in 59 cycles, and machine-smelted `iron_ingot:1` from episode-acquired raw iron and coal. It passed 74/74 checks in 271.922 seconds, sealed with 28.000 seconds remaining, kept health/hunger at 20, and had zero deaths. Its 18 failed actions were recovered noise, including one physical furnace placement observed after a backend block-update timeout. Probe 50 evidence is pending this commit and push; Probe 51 is unauthorized and BM-014 remains locked pending that push and a separate offline verifier repair.
...
| M4 | Autonomous Survival | **Partial (`partial`)** | BM-011, BM-012, and BM-013 repeat_verified 3/3; BM-014 not run and locked |
