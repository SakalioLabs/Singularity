...
- M4 is `partial` and still incomplete; BM-011 remains repeat-verified, but BM-012 is only 1/3 after forty-two retained failed live attempts and one eligible Probe 38 success. The phase is not complete until BM-011 through BM-014 each reach 3/3.
...
| M4 | Autonomous Survival | **Partial (`partial`)** | BM-011 repeat_verified 3/3; BM-012 Probe 38 success 1/3 plus Probe 43 retained failure and place-feedback repair pending push; BM-013..014 not_run |
