...
- M4 is `live_observed` but still incomplete. BM-011, BM-012, and BM-013 are each repeat-verified at 3/3 after eligible Probe 50 closed BM-013. BM-014 is live-observed at 1/3 after two authorized attempts: Probe 51 is retained as one failure, while Probe 52 independently completed the full empty-inventory iron-pickaxe chain.
...
- Probe 52 episode `m4_episode_20260727_153112_f28d04d6` completed all 11 goals in 67 cycles and 286.188 seconds. It machine-smelted three ingots, crafted the required sticks and `iron_pickaxe:1`, preserved health/hunger at 20, had zero deaths or respawns, used no skills, and passed 74/74 eligibility checks with 13.812 seconds of runtime margin. The repaired furnace path first encountered one backend block-update timeout, then selected another exact same-snapshot solid-reference/air-target pair and successfully placed the furnace. This is BM-014 success 1/3; its evidence is being retained in the current evidence transaction, and Probe 53 remains unauthorized until that transaction is pushed and independently read back.
- The current `m4-fixed-v1` ledger contains 28 live episodes, Probes 25–52. Probe 51's earlier Python 3.13.5 startup correction had no `autonomous_start` or session JSONL and counts as neither an episode, attempt, nor retry.
...
| M4 | Autonomous Survival | **Live observed (`live_observed`)** | BM-011, BM-012, and BM-013 repeat_verified 3/3; BM-014 live_observed 1/3 after eligible Probe 52, Probe 53 locked pending evidence push/readback |
