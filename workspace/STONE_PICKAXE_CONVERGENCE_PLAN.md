...
Current authorization: **no live episode is authorized**. Candidates `r1`, `r4`, `r7`, `r10`, and `r11` are consumed and cannot be retried; `r2/r3/r5/r6/r8/r9` remain excluded, while `r12` remains locked pending pushed r11 evidence and separate review. R11 passed from authorization commit `41ce0d14`, and v4 is now 2/3. Another fixture session, support reruns, retries, SP-002/SP-003, Probe 24, full BM-012, and iron mining remain locked.
