...
Current authorization: **no live episode is authorized**. Candidates `r1`, `r4`, `r7`, and `r10` are consumed and cannot be retried; `r2/r3/r5/r6/r8/r9` remain excluded, while `r11/r12` remain locked pending the pushed offline preflight fix and separate review. R10 passed from authorization commit `5ad854d1`, its evidence is pushed at `90e4e230`, and v4 is now 1/3. Another fixture session, support reruns, retries, SP-002/SP-003, Probe 24, full BM-012, and iron mining remain locked.
