...
Current authorization: **none**. Replicates `r1..r14` are excluded or consumed and cannot re-enter v5; r12 is infrastructure-ineligible, and r13/r14 passed exactly once from authorization commits `02269113` and `2ebbdace`. R15 requires a separate ledger commit only after the r14 evidence is pushed. Another fixture session, support reruns, retries, SP-002/SP-003, Probe 24, full BM-012, and iron mining remain locked.
