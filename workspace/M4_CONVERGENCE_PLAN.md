...
The separate stone-pickaxe skill project remains non-capability research and does not authorize another M4 probe. SP-001 is 3/3 with executable `learned:acquire_cobblestone@1.1.0`; SP-002 is 3/3 with nonexecutable candidate `a488cd61` pending review, while SP-003 remains locked. A sealed 48-file SP-002 fixture has exact three cobblestone, two sticks, no target, and an interactive table. Five live SP-002 authorizations are permanently consumed: the first two retain their root-graph and stale-inventory failures, while the last three independently validate the Phase 51 repair. Episodes `sp002_live_20260718_193656_a6ce837e`, `sp002_live_20260718_201122_e277e1cb`, and `sp002_live_20260718_203340_c9749b39` each used one schema-valid real Planner call and one Mineflayer craft attempt, completed both task nodes, and proved exact `cobblestone:-3`, `stick:-2`, and `stone_pickaxe:+1` through the authoritative crafting-window refresh. Phase 58 source tooling is pushed at `48000e10`; Phase 59 extraction changes no runtime skill record and keeps SP-002 executable promotion disabled. No additional SP-002 live authorization is open, and M4 status and all capability counts are unchanged.
