...
- Current target: BM-014 Craft iron pickaxe; Probes 51, 53, and 54 are retained as three ineligible attempts, Probe 52 is the first independently eligible success, and Probe 55's one-use authorization is pending its own commit/push/readback against the published Probe 54 portable-crafting-table recovery
...
## Probe 55 One-Use Authorization
...
- Authorization artifacts: `workspace/evals/m4_probe55_authorization.json`, SHA-256 `f8526bbeca23d7b676615d95c2f0eff367244c29a4b4389802116bfee7a67464`, and `tests/test_m4_probe55_authorization.py`, SHA-256 `1c3222a5c9e7ce2ee99660fda7aafe82c592c6159cbb91df6c8a403e6477beaa`, bound to policy `m4-bm013-bm014-portable-crafting-table-recovery-v1`; the focused authorization suite passes 5/5
- Scope: exactly one fresh BM-014 episode, fixed 300-second task limit, skills off, one Planner transport attempt, zero client/proxy retries, and credential/provider preflight before Minecraft
- Prior state: four BM-014 attempts, three retained failures, one independently eligible success, and two eligible successes still required; authorization issuance adds no episode, attempt, success, or capability credit
- Publication gate: the authorization is staged and pending its own commit/push/readback, so it is not yet usable and no Probe 55 episode may run; BM-014 remains globally unauthorized and locked, and Probe 56 is unauthorized
