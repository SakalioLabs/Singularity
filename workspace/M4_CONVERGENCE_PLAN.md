...
- Current target: BM-014 Craft iron pickaxe; Probes 51, 53, and 54 are retained as three ineligible attempts, Probe 52 is the first independently eligible success, and the bounded Probe 54 portable-crafting-table recovery is pending this evidence/repair transaction's commit/push/readback
...
- Publication gate: Probe 54 evidence and the bounded repair are pending this transaction's commit/push/readback; Probe 55 remains unauthorized
