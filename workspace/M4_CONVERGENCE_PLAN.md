...
The separate stone-pickaxe skill project remains non-capability research and does not authorize another M4 probe. SP-001 is 3/3 with executable `learned:acquire_cobblestone@1.1.0`; SP-002 is 3/3 and candidate-extraction ready, while SP-003 remains locked. A sealed 48-file SP-002 fixture has exact three cobblestone, two sticks, no target, and an interactive table. Five live SP-002 authorizations are permanently consumed: the first two retain their root-graph and stale-inventory failures, while the last three independently validate the Phase 51 repair. Episodes `sp002_live_20260718_193656_a6ce837e`, `sp002_live_20260718_201122_e277e1cb`, and `sp002_live_20260718_203340_c9749b39` each used one schema-valid real Planner call and one Mineflayer craft attempt, completed both task nodes, and proved exact `cobblestone:-3`, `stick:-2`, and `stone_pickaxe:+1` through the authoritative crafting-window refresh. They passed machine verification and evidence eligibility in 5.453, 5.515, and 6.250 seconds with no retry or continuation call. Phase 58 validates task-specific 17-file candidate sources and keeps SP-002 executable promotion disabled; 18 SP-002, 36 protocol, 46 non-live Python, and six Node suites pass. No additional SP-002 live authorization is open, and candidate extraction remains separate and nonexecutable. M4 status and all capability counts are unchanged.
