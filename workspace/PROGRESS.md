...
- Offline validation passes 30/30 protocol cases and 27/27 runtime cases. The repository-wide non-live gate covers M1/M2/M3, GoalVerifier, TaskSystem, Skill runtime, ActionController, M4 deadlines, fixed Node suites, and Python compilation.
...
- All four failed preparations, the successful non-counting preparation, both failed SP-001 episodes, and both successful SP-001 episodes remain immutable. Paper and Bridge stopped, ports `25565` and `30000` are clear, the fixture tree still audits to `996b2a1f989626e9c44ddca5c24f81ae55a5dca03b246f0d72723c46fd6a7636`, and one conditional SP-001 authorization becomes consumable only after this 2/3 evidence commit is pushed.
