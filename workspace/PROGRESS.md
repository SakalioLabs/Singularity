...
- Sealed-fixture commit `aa8b7e6` remains synchronized in history; SP-001 is 1/3, SP-002 is 0/3, SP-003 is locked, and neither prospective learned skill exists.
...
- All four failed preparations, the successful non-counting preparation, both failed SP-001 episodes, and the first successful SP-001 episode remain immutable. Paper and Bridge stopped, ports `25565` and `30000` are clear, the fixture tree still audits to `996b2a1f989626e9c44ddca5c24f81ae55a5dca03b246f0d72723c46fd6a7636`, and one conditional SP-001 authorization becomes consumable only after this 1/3 evidence commit is pushed.
