...
- [ ] Run `skill-memory-quality-gate` on real `skill-memory-report` plus `skill-memory-quality-report` artifacts before making any skill-memory REUSE path a default runtime profile.
