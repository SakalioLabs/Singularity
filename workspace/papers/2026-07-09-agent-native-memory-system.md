...
**Singularity Adaptation**:
  ...
  - `SkillLibrary.record_skill_memory_quality_feedback()` performs localized retrieval-ranking maintenance: conflicted `REUSE` hints are demoted, `AVOID` warnings can be made more visible, and `REVIEW_ONLY` remains gated.
