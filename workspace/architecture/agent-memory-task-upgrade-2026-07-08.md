...
- Reviewed Blind Curator, SkillCenter, and EvoSOP for the next lifecycle step. Rejected skills are already excluded by governance, but contribution-based soft retirement still needs verifier-backed defect injection and no-skill baselines; automatic deletion or LLM-only retirement remains prohibited.
