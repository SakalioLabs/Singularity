...
- Built-in lineage fixtures currently produce 2/3 review-ready cases, reduce failed-branch contamination from 2 to 0, and improve mean path precision by 0.5. Candidate context is longer than the flat formatter, so no token-efficiency claim is made and context compaction remains pending.
