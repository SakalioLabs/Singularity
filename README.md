...
Current status: M1, M2, and M3 are `repeat_verified`. M1 has BM-001..005 at 3/3 (`15/15` distinct eligible live successes). M2 has BM-006 and BM-007 at three eligible baseline/candidate pairs each, BM-008..010 at 3/3 independent successes each, and two eligible recovery sessions. M3 has three later-session skill retrieval/outcome cases plus approved held-out transfer evidence. M4 is `failing`: BM-011 has three independently eligible fresh survival-to-dawn episodes, BM-012 has twenty-one failed attempts and remains 0/3, and BM-013..014 remain unverified. Probe 21 ran once from frozen commit `84ca601` and live-activated `m4-ready-task-goal-verifier-success-criteria-v1`: 61 machine-readable decisions retained or suppressed unverified completion (`37` retain, `24` suppress, `0` allow). Exact bound task `7790c984` became active at event 814 and failed at event 851; when event 970 later placed the table and event 973 verified the generic goal, event 974 correctly kept completion suppressed because that bound task was not machine-completed. Independent review overrides Runner event 318 because the episode recovered through the event-970 table and event-1491 wooden pickaxe. The earliest unrecovered transition is now `m4_readiness_recovery_inventory_family_root_completion_disconnect`: event 1504 replaced the iron-progression fallback with an exact-`oak_log` recovery for stale task `d37f41ea`; events 1512/1513 immediately machine-completed the created recovery task by projecting `dark_oak_log:4` to canonical `oak_log:4`, but plan event 1519 still reasoned that the exact count was zero and event 1532 executed an unnecessary move. The root consumed nine cycles and event 1721 suspended it at dusk with six stale blocked crafting tasks still accepted. The episode ended at the 600-second deadline with no iron, 64/74 checks passing, and a connected zero-death last valid observation. Probe 21 consumed its sole live authorization. No Probe 22 is authorized until a bounded offline gate reconciles inventory-family machine completion with the active readiness-recovery root; BM-013/BM-014 remain locked. The sole authoritative audit is `workspace/evals/capability_evidence_current.json`.
